...
if __name__ == '__main__':
    with app.app_context():
        ...
        user1 = User( name='Hậu',username='lehuuhau', password=str(hashlib.md5('123'.encode('utf-8')).hexdigest()),
        ...
        reservation_data = [
            {'customer_id': 2, 'user_id': 3, 'room_id': 4, 'check_in_date': datetime(2024, 1, 9, 17, 1),
             'check_out_date': datetime(2024, 1, 19, 17, 1), 'deposit': 900000},
            ...
            {'customer_id': 2, 'user_id': 3, 'room_id': 2, 'check_in_date': datetime(2023, 12, 11, 17, 12),
             'check_out_date': datetime(2023, 12, 21, 17, 12), 'deposit': 1500000},
            {'customer_id': 1, 'user_id': 3, 'room_id': 6, 'check_in_date': datetime(2024, 1, 9, 17, 1),
        ...
        #         ==============================Thêm hóa đơn======================================
        bill_data=[{'user_id': 3, 'room_rental_form_id': 1, 'total_price': 2000000, 'created_date': datetime(2023, 1, 19, 17, 1)},
            {'user_id': 3, 'room_rental_form_id': 2, 'total_price': 5000000, 'created_date': datetime(2023, 1, 29, 17, 11)},
            {'user_id': 3, 'room_rental_form_id': 3, 'total_price': 4000000, 'created_date': datetime(2023, 2, 19, 17, 11)},
            {'user_id': 3, 'room_rental_form_id': 4, 'total_price': 1000000, 'created_date': datetime(2023, 4, 29, 17, 11)}]
        for b in bill_data:
            bill = Bill(**b)
            db.session.add(bill)
        db.session.commit()
        ...
        comment_data=[{'customer_id':1, 'content':'Phòng này quá ok <3', 'room_id':1,
                      ...
                      {'customer_id': 2, 'content': 'Sẽ ghé thăm vào lần sau nếu có dịp', 'room_id': 2,
                       'created_date': datetime(2024, 1, 9, 17, 1)},
                      {'customer_id': 1, 'content': 'Một căn phòng đáng trải nghiệm nhất tại khách sạn, 5 sau nhé', 'room_id': 4,
                       'created_date': datetime(2024, 1, 9, 17, 1)}]
